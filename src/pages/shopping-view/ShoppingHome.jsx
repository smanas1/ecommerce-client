...
import ImprovedCarousel from "@/components/ui/improved-carousel";
...
function ShoppingHome() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            {categoriesWithIcon.map((categoryItem, index) => {
              ...
              return (
                <Card
                  ...
                  className="cursor-pointer hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden group shadow-lg"
                >
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-700 text-white relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10">
          <div className="absolute top-10 left-10 w-64 h-64 bg-white rounded-full opacity-20 animate-pulse"></div>
          <div className="absolute bottom-10 right-10 w-48 h-48 bg-white rounded-full opacity-20 animate-pulse"></div>
        </div>
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button
              size="lg"
              className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-purple-900 hover:from-yellow-300 hover:to-yellow-400 text-lg px-8 py-6 rounded-full shadow-lg font-bold"
              onClick={() => navigate("/shop/listing")}
            >
              Shop the Sale
            </Button>
            <Button
              variant="outline"
              size="lg"
              className="bg-white/10 border-2 border-white text-white hover:bg-white hover:text-purple-600 text-lg px-8 py-6 rounded-full shadow-lg font-bold"
              onClick={() => navigate("/shop/listing")}
            >
              View All Deals
            </Button>
            ...
            {brandsWithIcon.map((brandItem, index) => {
              ...
              return (
                <Card
                  ...
                  className="cursor-pointer hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden group shadow-md"
                >
                  <CardContent className="flex flex-col items-center justify-center p-6 relative">
                    <div
